...
public class Logger {
    ...
    @Around(value = "execution(* com.talentPool.candidatePortal..*.*(..))")
    ...
    @AfterThrowing(pointcut = "execution(* com.talentPool.candidatePortal..*.*(..))", throwing = "ex")
